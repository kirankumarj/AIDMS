...
@Component({
  selector: 'app-assert-create',
  templateUrl: './assert-create.component.html',
  styleUrls: ['./assert-create.component.css']
})
export class AssertCreateComponent implements OnInit, AfterViewInit {
  office: Office;
  step = 0;
  searchAddress;
